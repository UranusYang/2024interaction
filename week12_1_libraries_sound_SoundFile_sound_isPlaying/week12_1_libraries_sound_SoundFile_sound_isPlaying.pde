...
// 我們教過 play() stop() pause()，今天要試isPlaying()是不是在播放
...
void setup(){
  size(640,360);
  background(255);
  sound1 = new SoundFile(this, "Intro Song_Final.mp3"); //week09_4 可下載
  sound2 = new SoundFile(this, "In Game Music.mp3"); //week09_4 可下載
}
void draw(){
